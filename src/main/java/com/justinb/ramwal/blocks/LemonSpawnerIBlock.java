...
public class LemonSpawnerIBlock extends Block {
    public static final int PINK_CHANCE = 5;
    ...
    protected void dispense(ServerWorld worldIn, BlockPos pos) {
        ...
        Item ent = ItemInit.LEMON.get();

        if (new Random().nextInt(100/PINK_CHANCE) == 0)
            ent = ItemInit.PINK_LEMON.get();
