...
public abstract class AbstractLemonSpawnerBlock extends Block {
    public static final Map<Item, IDispenseItemBehavior> DISPENSE_BEHAVIOR_REGISTRY = Util.make(new Object2ObjectOpenHashMap<>(), (behaviour) -> behaviour.defaultReturnValue(new DefaultDispenseItemBehavior()));

    public static final BooleanProperty POWERED = BlockStateProperties.POWERED;
    public static final DirectionProperty FACING = DirectionalBlock.FACING;

    public static Supplier<Item> toDispense = () -> LemonInit.LEMON.get();

    public AbstractLemonSpawnerBlock(Properties properties) {
        super(properties);
