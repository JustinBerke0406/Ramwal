...
public class DeriverScreenContainer extends ContainerScreen<DeriverContainer> {
    private DeriverContainer container;

    public DeriverScreenContainer(DeriverContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
    ...
    private static final ResourceLocation TEXTURE = new ResourceLocation("ramwal", "textures/gui/deriver_bg.png");
}
