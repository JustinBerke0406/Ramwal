...
public class IntegratorScreenContainer extends ContainerScreen<IntegratorContainer> {
    private IntegratorContainer container;

    public IntegratorScreenContainer(IntegratorContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
    ...
    final static int PLAYER_INV_LABEL_XPOS = IntegratorContainer.PLAYER_INVENTORY_XPOS;
    final static int PLAYER_INV_LABEL_YPOS = IntegratorContainer.PLAYER_INVENTORY_YPOS - FONT_Y_SPACING;
    ...
    private static final ResourceLocation TEXTURE = new ResourceLocation("ramwal", "textures/gui/integrator_bg.png");
}
